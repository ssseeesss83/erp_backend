...
public interface PurchaseService {
    ...
    PurchaseSheetVO getLatest();

    List<PurchaseSheetVO> getBusinessProcess(BusinessProcessFilterVO filterVO);

    void redFlush(PurchaseSheetVO purchaseSheetVO);

    PurchaseSheetVO redFlushCopy(PurchaseSheetVO purchaseSheetVO);

    void copyIn(PurchaseSheetVO purchaseSheetVO);
}
