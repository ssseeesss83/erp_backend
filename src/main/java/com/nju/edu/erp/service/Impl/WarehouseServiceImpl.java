...
//            warehouseDao.deductQuantity(warehousePO);
    ...
    @Override
    public List<WarehouseInputFormVO> getBusinessProcessIn(BusinessProcessFilterVO filterVO) {
        List<WarehouseInputSheetPO> warehouseInputSheetPOS = warehouseInputSheetDao.getBusinessProcess(filterVO);
        List<WarehouseInputFormVO> warehouseInputFormVOS = new ArrayList<>();
        for(WarehouseInputSheetPO warehouseInputSheetPO:warehouseInputSheetPOS){
            List<WarehouseInputSheetContentPO> warehouseInputSheetContentPOS = warehouseInputSheetDao.getAllContentById(warehouseInputSheetPO.getId());
            List<WarehouseInputFormContentVO> warehouseInputFormContentVOS = new ArrayList<>();
            for (WarehouseInputSheetContentPO warehouseInputSheetContentPO:warehouseInputSheetContentPOS){
                WarehouseInputFormContentVO warehouseInputFormContentVO = new WarehouseInputFormContentVO();
                BeanUtils.copyProperties(warehouseInputSheetContentPO,warehouseInputFormContentVO);
            ...
            BeanUtils.copyProperties(warehouseInputSheetPO,warehouseInputFormVO);
            warehouseInputFormVO.setList(warehouseInputFormContentVOS);
        }
        return warehouseInputFormVOS;
    }
