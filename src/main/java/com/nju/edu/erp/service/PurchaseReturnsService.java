...
public interface PurchaseReturnsService {
    ...
    PurchaseReturnsSheetVO getLatest();

    List<PurchaseReturnsSheetVO> getBusinessProcess(BusinessProcessFilterVO filterVO);

    void redFlush(PurchaseReturnsSheetVO purchaseReturnsSheetVO);

    PurchaseReturnsSheetVO redFlushCopy(PurchaseReturnsSheetVO purchaseReturnsSheetVO);

    void copyIn(PurchaseReturnsSheetVO purchaseReturnsSheetVO);
}