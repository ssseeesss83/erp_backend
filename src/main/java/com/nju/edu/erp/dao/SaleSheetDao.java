...
public interface SaleSheetDao {
    ...
    List<SaleSheetPO> findAllSheetByStateAndSaleMan(String employeeName, SaleSheetState state, Date beginDateOfMonth, Date endDateOfMonth);

    List<SaleSheetPO> getAllSheetByYearAndMonth(SaleSheetState state,Date beginDateOfMonth, Date endDateOfMonth);

    List<SaleSheetPO> getBusinessProcess(BusinessProcessFilterVO filterVO);
}
