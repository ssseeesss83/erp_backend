...
public class PurchaseController {
    ...
    public Response getBusinessProcess(@RequestBody BusinessProcessFilterVO filterVO){
        return Response.buildSuccess(purchaseService.getBusinessProcess(filterVO));
    }
    ...
    public Response redFlush(@RequestBody PurchaseSheetVO purchaseSheetVO){
        purchaseService.redFlush(purchaseSheetVO);
        return Response.buildSuccess();
    }
    ...
    @Authorized(roles = {Role.FINANCIAL_STAFF, Role.ADMIN})
    public Response redFlushCopy(@RequestBody PurchaseSheetVO purchaseSheetVO){
        return Response.buildSuccess(purchaseService.redFlushCopy(purchaseSheetVO));
    }
    ...
    @Authorized(roles = {Role.FINANCIAL_STAFF, Role.ADMIN})
    public Response copyIn(@RequestBody PurchaseSheetVO purchaseSheetVO){
        purchaseService.copyIn(purchaseSheetVO);
        return Response.buildSuccess();
    }
